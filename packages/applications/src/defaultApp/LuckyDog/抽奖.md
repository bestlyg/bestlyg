...
import { LuckyDog } from '@bestlyg/applications';
export default LuckyDog;
```

## [核心代码](https://gitee.com/bestlyg/bestlyg/tree/master/packages/applications/src/defaultApp/LuckyDog/useLuckyDog.ts)
