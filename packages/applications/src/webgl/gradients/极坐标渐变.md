...
- 原理
  - 默认中心点水平右侧为 0° 位置
  - 对每个片元利用 x、y 值求出弧度**curRad**，求出与 2π 的比例**curRatio**
  - 根据比例锁定颜色锁在的范围，并求出插值
...
export default Webgl.PolarGradient;
```

## [核心代码](https://gitee.com/bestlyg/bestlyg/tree/master/packages/applications/src/webgl/gradients/PolarGradient.tsx)
