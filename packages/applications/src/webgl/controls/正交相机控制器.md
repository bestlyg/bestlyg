...
export default Webgl.OrthographicControls;
```

## [核心代码](https://gitee.com/bestlyg/bestlyg/tree/master/packages/applications/src/webgl/controls/OrthographicControls.tsx)
