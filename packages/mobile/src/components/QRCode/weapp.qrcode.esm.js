...
(QR8bitByte.prototype = {
  ...
  (QRCode.prototype = {
    ...
    setupTypeInfo: function (t, e) {
      for (
        var r = (this.errorCorrectLevel << 3) | e, o = QRUtil.getBCHTypeInfo(r), n = 0;
        n < 15;
        n++
      ) {
        var i = !t && 1 == ((o >> n) & 1);
  ...
  (QRCode.createData = function (t, e, r) {
    ...
    for (
      ;
      !(n.getLengthInBits() >= 8 * s || (n.put(QRCode.PAD0, 8), n.getLengthInBits() >= 8 * s));
  ...
  (QRCode.createBytes = function (t, e) {
    for (
      var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), s = 0;
      s < e.length;
      s++
    ) {
      var u = e[s].dataCount,
...
function drawQrcode(t, e) {
  if (
    ...
    if ((t.paddingColor || (t.paddingColor = t.background), e)) {
      var r = new QRCode(t.typeNumber, t.correctLevel);
      return (
    ...
    return new Promise(function (e, r) {
      return e(
        (function () {
          ...
          e.addData(utf16to8(t.text)), e.make();
          const r = wx.getSystemInfoSync().pixelRatio;
          var o = t.canvas;
          const n = o.getContext('2d');
          (o.width = t.width * r), (o.height = t.width * r);
          const i = o.width;
          (n.fillStyle = t.paddingColor), n.fillRect(0, 0, i + 2 * t.padding, i + 2 * t.padding);
          for (
            var a = (i - 2 * t.padding) / e.getModuleCount(),
              s = (i - 2 * t.padding) / e.getModuleCount(),
              u = 0;
            u < e.getModuleCount();
            u++
          )
            for (var l = 0; l < e.getModuleCount(); l++) {
              n.fillStyle = e.isDark(u, l) ? t.foreground : t.background;
              var h = Math.ceil((l + 1) * a) - Math.floor(l * a),
                f = Math.ceil((u + 1) * a) - Math.floor(u * a);
              n.fillRect(Math.round(l * a) + t.padding, Math.round(u * s) + t.padding, h, f);
            }
          if (t.image.imageResource) {
            const e = t.image.width * r,
              o = t.image.height * r,
              a = (i - e) / 2,
              s = (i - o) / 2;
            if (t.image.round) {
              const o = t.image.width * r + 30,
                u = (i - o) / 2,
                l = o / 2,
                h = u + l;
              n.beginPath(),
                n.arc(h, h, l, 0, 2 * Math.PI),
                (n.fillStyle = '#ffffff'),
                n.fill(),
                n.restore();
              const f = e / 2,
                ...
                c = s + f;
              n.beginPath(),
                n.arc(g, c, f, 0, 2 * Math.PI),
                n.clip(),
                n.drawImage(t.image.imageResource, a, s, e, e),
                n.restore();
...
(QRPolynomial.prototype = {
  ...
  (QRRSBlock.getRSBlocks = function (t, e) {
    ...
    for (var o = r.length / 3, n = new Array(), i = 0; i < o; i++)
      for (var a = r[3 * i + 0], s = r[3 * i + 1], u = r[3 * i + 2], l = 0; l < a; l++)
