  ...
  return (
    <View className={baseStyles.form}>
      ...
      <View className={baseStyles.form_item}>
        ...
        >
          <View className={baseStyles.form_input}>{dayjs(form.date).format('YYYY-MM-DD')}</View>
        </Picker>
      </View>
      <View className={baseStyles.form_item}>
        ...
        <Picker
          ...
          onChange={e =>
            setForm({
              ...form,
              typeId: types?.find(v => v.name === typeList[+e.detail.value])?._id ?? '',
            })
          }
          range={typeList}
        >
      ...
      <View className={baseStyles.form_item}>
        ...
        <Picker
          ...
          onChange={e =>
            setForm({
              ...form,
              accountId: accounts?.find(v => v.name === accountList[+e.detail.value])?._id ?? '',
            })
          }
          range={accountList}
        >
      ...
      <AtModal isOpened={modalVisible}>
        ...
        <AtModalContent>
          ...
          <View>账户：{accounts?.find(v => v._id === form.accountId)?.name ?? '暂无'}</View>
