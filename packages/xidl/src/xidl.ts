...
export class XIdl extends Hookable {
    hooks = Object.freeze({
        ...
        onGenObj: new tapable.AsyncSeriesWaterfallHook<[string, pb.ReflectionObject]>([
            'code',
            'obj',
        ]),
        ...
        onGenOutputArgs: new tapable.AsyncSeriesWaterfallHook<[{ path: string; code: string }]>([
            'args',
        ]),
        afterGenOutputArgs: new tapable.AsyncSeriesWaterfallHook<[{ path: string; code: string }]>([
            'args',
        ]),
    });
