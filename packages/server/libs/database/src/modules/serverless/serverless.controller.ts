...
const config = serverlessResourceSchema;
...
export class ServerlessController {
    ...
    @Get('page')
    async findPageAndCount(@Query() query: ServerlessPageRequestDto) {
    ...
    async exportXlsx(@Res() res: Response) {
        ...
        const output = new ServerlessExportResponseDto({
    ...
    @Post()
    async save(@Body() body: ServerlessCreateRequestDto) {
        const data = await this.service.save(body);
        return ResponseEntity.ofSuccess(data);
    }

    @Post('batch')
    async saveBatch(@Body() body: ServerlessBatchCreateRequestDto) {
        const data = await this.service.save(body);
        return ResponseEntity.ofSuccess(data);
    }
    ...
    @Patch('batch')
    async updateBatch(@Body() body: ServerlessBatchUpdateRequestDto) {
    ...
    async update(
        ...
        @Body() body: ServerlessUpdateRequestDto,
    ) {
