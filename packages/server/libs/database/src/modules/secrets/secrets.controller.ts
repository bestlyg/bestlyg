...
const config = secretsResourceSchema;
...
export class SecretsController {
    ...
    @Get('page')
    async findPageAndCount(@Query() query: SecretsPageRequestDto) {
    ...
    async exportXlsx(@Res() res: Response) {
        ...
        const output = new SecretsExportResponseDto({
    ...
    @Post()
    async save(@Body() body: SecretsCreateRequestDto) {
        const data = await this.service.save(body);
        return ResponseEntity.ofSuccess(data);
    }

    @Post('batch')
    async saveBatch(@Body() body: SecretsBatchCreateRequestDto) {
        const data = await this.service.save(body);
        return ResponseEntity.ofSuccess(data);
    }
    ...
    @Patch('batch')
    async updateBatch(@Body() body: SecretsBatchUpdateRequestDto) {
    ...
    async update(
        ...
        @Body() body: SecretsUpdateRequestDto,
    ) {
