...
![图片](/static?p=docs/WEB/static/ts-bug-peer-dep-1.png&r=false)
![图片](/static?p=docs/WEB/static/ts-bug-peer-dep-2.png&r=false)
...
![图片](/static?p=docs/WEB/static/ts-bug-peer-dep-3.png&r=false)
...
![图片](/static?p=docs/WEB/static/ts-bug-peer-dep-4.png&r=false)
...
![图片](/static?p=docs/WEB/static/ts-bug-peer-dep-5.png&r=false)
...
![图片](/static?p=docs/WEB/static/ts-bug-peer-dep-6.png&r=false)
