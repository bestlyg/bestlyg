...
NEW_CONTRACT_BYTES=`cat ./target/wasm32-unknown-unknown/release/bestlyg_guess_beads_contract.wasm | base64`
near call bestlyg-guess-beads.testnet update_contract "$NEW_CONTRACT_BYTES"               \
    --node_url https://near-testnet.infura.io/v3/f7c0b2130fd6470fbbdb7e12c0a17d7f  \
    --base64                                                                       \
